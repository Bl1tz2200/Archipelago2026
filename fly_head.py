...
APPLES = {
    "красное": [((0, 110, 70), (8, 255, 255)), ((170, 110, 70), (179, 255, 255))],
    "зелёное": [((15, 29, 0), (43, 255, 210))],
    "жёлтое": [((13, 140, 85), (32, 255, 255))],
}
APPLE_MIN_PERCENT = 0.13   # пятно мельче этой доли кадра — шум, не яблоко
APPLE_MIN_ROUND = 0.55     # круглость: 1.00 — идеальный круг
